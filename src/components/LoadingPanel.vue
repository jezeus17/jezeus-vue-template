<template>
    <div v-if="props.loading" :class="`${centered ? 'items-center justify-center ' : ''}bg-white dark:bg-zinc-9 z-3 opacity-80 w-full h-full absolute top-0 left-0 rounded-xl flex
        `">
    ...
    <div v-else-if="props.error" :class="`${centered ? 'items-center justify-center ' : ''}bg-white dark:bg-zinc-9 z-3 opacity-80 w-full h-full absolute top-0 left-0 rounded-xl flex
        justify-center`">
