    ...
    <Card overflow-auto h-full>
        <template #content>
            <TreeTable v-model:expandedKeys="expandedKeys" sortMode="multiple" removableSort ref="dt" scrollable
                scrollHeight="flex" size="small" tableStyle="min-width: 50rem" :value="tableData" :rows="5"
                :filters="filters" :filterMode="filterMode.value">
                    ...
                    <div class="custom-table-header">
                        ...
                        <div class="custom-table-header__options">
                            <IconField>
                                ...
                                <InputText w-12rem lg:w-20rem v-model="filters['global']"
                ...
                <div v-for="(col, index) in props.model.getColumns()" :key="index">
                    <Column expander v-if="col.expander" :field="fiedAsExpander.field"
                        :header="t(fiedAsExpander.header)">
