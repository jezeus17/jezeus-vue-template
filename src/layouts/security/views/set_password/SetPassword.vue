...
const { mutate, isPending } = useMutation({
  ...
  mutationFn: () => {
    ...
    toast.add({ severity: 'error', summary: t('global.operation_failed'), detail: decodedToken, life: 5000 });
    return sendRequest({ url: 'auth_assignment', method: "POST", token: encodedToken, body: { ...decodedToken, iat: undefined } })
